...
class BenchmarkRunner:
        ...
        try:
            ...
            for i in range(self.num_frames):
                ...
                if (i + 1) % 10 == 0:
                    ...
                    print(f"  Frame {i+1}/{self.num_frames}: {fps:.2f} FPS (avg: {avg:.2f})")
    ...
    def print_summary(self):
        ...
        # 표 형식 출력
        print(f"{'Detector':<15} {'Tracker':<15} {'Avg FPS':>10} {'Min FPS':>10} {'Max FPS':>10}")
        print(f"{'-'*70}")
        ...
        for i, result in enumerate(sorted_results, 1):
            print(f"{result['detector']:<15} {result['tracker']:<15} "
        ...
        if error_results:
            ...
            for result in error_results:
                print(f"  {result['detector']} + {result['tracker']}: {result['error']}")
